...
const Index = () => {
  return (
    <div className="min-h-screen">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[60] focus:px-4 focus:py-2 focus:bg-silver focus:text-navy focus:rounded-md focus:font-medium focus:shadow-lg transition-all"
      >
