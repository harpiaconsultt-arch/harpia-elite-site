    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12 text-center">
        <div className="max-w-5xl mx-auto">
          {/* Main Headline - H1 */}
          <h1 className="font-sans text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold text-foreground leading-tight mb-8 opacity-0 animate-fade-up animation-delay-100">
          ...
          <p className="text-silver text-base md:text-lg lg:text-xl max-w-2xl mx-auto mb-6 opacity-0 animate-fade-up animation-delay-200">
            Laudos técnicos, perícias e vistorias de engenharia civil em Barbacena – MG.
          </p>

          {/* Supporting phrase */}
          <p className="text-silver/70 text-sm md:text-base max-w-xl mx-auto mb-12 italic opacity-0 animate-fade-up animation-delay-200">
