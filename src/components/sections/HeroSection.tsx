  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={heroImage}
          alt="LIDAR scanning technology for structural inspection"
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-semibold text-foreground leading-tight mb-8 opacity-0 animate-fade-up animation-delay-100">
            ...
            <span className="block text-silver-light">toda decisão é chute caro.</span>
          </h1>

          {/* Subtitle */}
          <p className="text-silver text-lg md:text-xl max-w-2xl mx-auto mb-12 leading-relaxed opacity-0 animate-fade-up animation-delay-200">
            Laudos técnicos e inspeções estruturais com tecnologia de ponta para decisões seguras e investimentos protegidos.
          </p>

          {/* CTA Button */}
          <div className="opacity-0 animate-fade-up animation-delay-300">
            <Button variant="hero" size="xl" className="animate-pulse-glow">
              Inspeção Estrutural de Alto Risco
            </Button>
          </div>
        </div>
      </div>
